  ...
  return (
    <main className="relative pb-16">
      <If
        ...
        Then={
          <div
            className="absolute inset-0 bg-black bg-opacity-70 backdrop-blur-sm flex items-center justify-center z-50"
            style={{ backdropFilter: "blur(5px)" }}
          >
            <form
              onSubmit={handleLogin}
              className="bg-white rounded-md p-6 w-96 shadow-lg"
            >
